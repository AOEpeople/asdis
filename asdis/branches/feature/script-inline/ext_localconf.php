...
$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['tslib/class.tslib_fe.php'][$extConf['hook']][PHP_INT_MAX]  = 'EXT:asdis/Classes/Typo3/Hook/ContentPostProcAll.php:&Tx_Asdis_Typo3_Hook_ContentPostProcAll->process';
unset($extConf);
...
$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['asdis']['scrapers'][] = array(
	'key'   => 'htmlScriptInline',
	'class' => 'Tx_Asdis_Content_Scraper_Html_ScriptInline',
	'file'  => PATH_tx_asdis . 'Classes/Content/Scraper/Html/ScriptInline.php'
);
